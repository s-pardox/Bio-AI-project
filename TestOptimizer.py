        ...
        def fn(dset, para):
            ...
            arranged_params = {
                'trainer': {
                    ...
                    'weight_decay': 0.00972140339475499
                },
                'encoder': {
                    'num_layers': 2,
            ...
            arranged_params = {
                'trainer': {
                    ...
                    'early_stopping_round': para['early_stopping_round'],
                    'lr': para['lr'],
                    'weight_decay': para['weight_decay']
                },
                'encoder': {
                    'num_layers': para['num_layers'],
                    'hidden': para['hidden'],               # Number of hidden units
                    'dropout': para['dropout'],
                    'act': para['act']                      # Activation function
                },
                'decoder': {}
            }
